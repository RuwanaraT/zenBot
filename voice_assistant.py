...
class ChatBot:
    ...
    def run(self):
        ...
        # Initial AI response
        initial_response = "Hello, I am zenBot. How can I help you?"
        #conversation.append({'AI': initial_response})  # Add to conversation list
        conversation.append('zenBot: ' + initial_response)
        ...
        while True:
            ...
            if wake_up(self.text, self.name):
                self.res = "Hello, I am an AI counselor. How can I help you?"
                ...
                conversation.append('zenBot: ' + self.res)
